        ...
        <Box component={Paper} sx={{p: 4}}>
            ...
            <form onSubmit={handleSubmit(handleSubmitData)}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        <AppTextInput mutliline={true} rows={4} control={control} name='description' label='Description' />
                    </Grid>
                    <Grid item xs={12}>
                ...
                <Box display='flex' justifyContent='space-between' sx={{mt: 3}}>
                    <Button onClick={cancelEdit} variant='contained' color='error'>Cancel</Button>
